...
public class Resource {
    /**
     * A Resource that indicates infinite resource that matches any resource requirement, for
     * testability purpose only.
     */
    @VisibleForTesting
    public static final Resource ANY =
            newBuilder()
    ...
    public static class Builder {
        ...
        public Resource build() {
            return new Resource(
                    cpuCores, taskHeapMemory, taskOffHeapMemory, managedMemory, networkMemory);
        }
    }
}
