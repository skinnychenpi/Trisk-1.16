...
//                                    return coordinator.synchronizeTasks(tasks, o); // CYH: This is the synchronizeTask method in ReconfigurationCoordinator.
//                                });
...
//                // 所有的downstream upstream 涉及到的operator以及其所管辖的task id都会被放入task这个map里面, 当然也包括target operator的未修改前的task id。
