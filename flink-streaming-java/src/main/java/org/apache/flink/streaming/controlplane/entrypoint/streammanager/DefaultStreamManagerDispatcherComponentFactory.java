 ...
 * components.
 */
public class DefaultStreamManagerDispatcherComponentFactory
        implements StreamManagerDispatcherComponentFactory {

    private final Logger log = LoggerFactory.getLogger(getClass());

    @Nonnull private final StreamManagerRestEndpointFactory<?> smRestEndpointFactory;

    @Nonnull private final StreamManagerDispatcherRunnerFactory smDispatcherRunnerFactory;
    ...
    public StreamManagerDispatcherComponent create(
        ...
        try {
            smDispatcherLeaderRetrievalService =
                    highAvailabilityServices.getStreamManagerDispatcherLeaderRetriever();

            final LeaderGatewayRetriever<StreamManagerDispatcherGateway>
            ...
            final ScheduledExecutorService executor =
                    StreamManagerWebMonitorEndpoint.createExecutorService(
            ...
            smWebMonitorEndpoint =
                    smRestEndpointFactory.createRestEndpoint(
                            configuration,
                            smDispatcherGatewayRetriever,
                            blobServer,
                            executor,
            ...
            final PartialStreamManagerDispatcherServices partialSmDispatcherServices =
                    new PartialStreamManagerDispatcherServices(
                            configuration,
            ...
            smDispatcherRunner =
                    smDispatcherRunnerFactory.createStreamManagerDispatcherRunner(
                            highAvailabilityServices
                                    .getStreamManagerDispatcherLeaderElectionService(),
                            fatalErrorHandler,
            ...
            return new StreamManagerDispatcherComponent(
                    smDispatcherRunner, smDispatcherLeaderRetrievalService, smWebMonitorEndpoint);
