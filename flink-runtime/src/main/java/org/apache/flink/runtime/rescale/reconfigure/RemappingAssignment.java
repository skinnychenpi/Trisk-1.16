...
public class RemappingAssignment implements AbstractCoordinator.Diff {
    ...
    public RemappingAssignment(
            Map<Integer, List<Integer>> newMapping, Map<Integer, List<Integer>> oldMapping) {
    ...
    private List<KeyGroupRange> generateAlignedKeyGroupRanges(
        ...
        for (List<Integer> list : partitionAssignment.values()) {
            ...
            KeyGroupRange keyGroupRange =
                    rangeSize == 0
                            ...
                            : new KeyGroupRange(keyGroupStart, keyGroupStart + rangeSize - 1, list);
    ...
    public boolean isTaskModified(int taskIndex) {
        ...
        return AbstractCoordinator.compareIntList(
                oldKeymapping.get(taskIndex), keymapping.get(taskIndex));
    }
