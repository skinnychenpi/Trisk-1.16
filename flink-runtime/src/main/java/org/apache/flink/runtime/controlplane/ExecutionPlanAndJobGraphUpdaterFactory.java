...
public interface ExecutionPlanAndJobGraphUpdaterFactory {
    ...
    ExecutionPlan createExecutionPlan(
            JobGraph jobGraph, ExecutionGraph executionGraph, ClassLoader classLoader);

    JobGraphUpdater createJobGraphUpdater(JobGraph jobGraph, ClassLoader classLoader);
}
