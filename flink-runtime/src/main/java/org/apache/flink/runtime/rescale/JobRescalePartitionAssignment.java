...
public class JobRescalePartitionAssignment {
    ...
    public JobRescalePartitionAssignment(
        ...
        checkState(
                checkPartitionAssignmentValidity(strExecutorMapping),
                "executorMapping has null or empty partition");

        checkState(
                checkPartitionAssignmentValidity(strOldExecutorMapping),
    ...
    public JobRescalePartitionAssignment(
            Map<String, List<String>> strExecutorMapping, int numOpenedSubtask) {
    ...
    private void setupFollowScaleIn(
        ...
        List<Integer> removedExecutorId =
                oldExecutorMapping.keySet().stream()
