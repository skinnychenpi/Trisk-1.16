 ...
 */
public class StreamManagerWebMonitorEndpoint<T extends StreamManagerRestfulGateway>
    ...
    public StreamManagerWebMonitorEndpoint(
        ...
        super(clusterConfiguration, endpointConfiguration);
    ...
    protected List<Tuple2<RestHandlerSpecification, ChannelInboundHandler>> initializeHandlers(
        ...
        final StreamManagerJobExecutionResultHandler jobExecutionResultHandler =
                new StreamManagerJobExecutionResultHandler(
                        leaderRetriever, timeout, responseHeaders);

        final RegisterStreamManagerControllerHandler registerStreamManagerControllerHandler =
                new RegisterStreamManagerControllerHandler(
                        leaderRetriever, timeout, responseHeaders);
        ...
        handlers.add(
                Tuple2.of(
                        registerStreamManagerControllerHandler.getMessageHeaders(),
                        registerStreamManagerControllerHandler));
